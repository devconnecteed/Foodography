...
class Onboarding03Widget extends StatefulWidget {
  ...
  static String routeName = 'Onboarding_03';
                  ...
                  Align(
                    ...
                    child: Transform.scale(
                      ...
                      child: FlutterFlowVideoPlayer(
                        path: 'assets/videos/4884030-hd_1080_1920_30fps.mp4',
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    alignment:
                                                        AlignmentDirectional(
                                                            0.0, 0.3),
                                                    child: Text(
                                                      'Goditi il tuo piatto preferito',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style:
                                                          FlutterFlowTheme.of(
                                                  ...
                                                  Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      const SizedBox(
                                                          width: 12.0),
                                                      // CTA PRIMARIA: Inizia (bg bianco, testo blu)
                                                      Expanded(
                                                        child: Align(
                                                          alignment:
                                                              AlignmentDirectional(
