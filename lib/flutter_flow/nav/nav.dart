...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: IniziaWidget.routeName,
          path: IniziaWidget.routePath,
        ...
        FFRoute(
          name: ScattaFotoWidget.routeName,
          path: ScattaFotoWidget.routePath,
          builder: (context, params) => ScattaFotoWidget(),
        ),
        FFRoute(
          name: ProfiloWidget.routeName,
          path: ProfiloWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Profilo')
              : ProfiloWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: FiltersSearchWidget.routeName,
          path: FiltersSearchWidget.routePath,
          builder: (context, params) => FiltersSearchWidget(),
        ),
        FFRoute(
          name: FiltersWidget.routeName,
          path: FiltersWidget.routePath,
        ...
        FFRoute(
          name: FiltriWidget.routeName,
          path: FiltriWidget.routePath,
          builder: (context, params) => FiltriWidget(),
        ),
        FFRoute(
          name: PosizioneAttualeWidget.routeName,
          path: PosizioneAttualeWidget.routePath,
          builder: (context, params) => PosizioneAttualeWidget(),
        )
